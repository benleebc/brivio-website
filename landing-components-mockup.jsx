...
},
{
  ...
  body: 'Licensing, compliance, underwriting, servicing \u2014 and the capital that funds every loan. We coordinate the full stack, so you don\u2019t have to. You never fund the loan book. When something needs attention, you call us. We handle it from there.'
}];

const WIN_POINTS = [
'No major capital commitment. Modest setup and subscription fees',
'You bring the loan rooftop. We bring the infrastructure & capital',
